...
- `docs/features/` — active SDD work items
...
- If a spec in `docs/features/` describes work that was just implemented, check whether acceptance criteria are met.
...
- Active SDD work kept in `docs/features/`, not scattered in ad-hoc locations.
