---
name: technical-cpp-reviewer
description: Reviews C++ code changes in the OpenTelemetry Demo for correctness, idiomatic style, OTel instrumentation, and test coverage. Covers: currency.
